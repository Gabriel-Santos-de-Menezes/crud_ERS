        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col">
                  <label class="col-md-3 control-label" for="rg">RG <h11>*</h11></label>
                  <div class="col-md-6">
                ...
                <div class="col">
                  ...
                  <div class="col-md-6">
                    <input id="cpf" name="cpf" placeholder="Apénas números" class="form-control input-md" required="" type="text" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" onBlur="showhide()">
                  </div>
                </div>
            ...
            <div class="form-group">
              ...
              <label class="col-md-3 control-label" for="dtNasc">Nascimento<h11>*</h11></label>
              <div class="col-md-3">
                <input id="dtnasc" name="data_nascimento" placeholder="DD/MM/AAAA" onkeypress="mascaraData(this)" class="form-control input-md" required="" type="text" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="input-group">
                    ...
                    <input id="prependedtext" name="telefone" class="form-control" onkeydown="javascript: fMasc( this, mTel );" maxlength="20" placeholder="XX XXXXX-XXXX" type="text" maxlength="13" pattern="\[0-9]{2}\ [0-9]{4,6}-[0-9]{3,4}$" OnKeyPress="formatar('## #####-####', this)">
                  </div>
                </div>
              </div>
